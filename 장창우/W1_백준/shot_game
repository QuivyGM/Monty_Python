...
background = pygame.transform.scale(pygame.image.load('bonobono.png'),(width,height))


pygame.display.set_caption("Move object with keyboard")
object_color=(255,0,0)
object_size=50
object_image = pygame.transform.scale(pygame.image.load('img.png'),(object_size,object_size))
object_x,object_y=width //2 ,height //2
object_speed = 10

bullet_image = pygame.transform.scale(pygame.image.load('jojo.png'),(60, 60))
bullet_speed = 10
bullets = []
...
enemy_image = pygame.transform.scale(pygame.image.load('fox.png'),(30, 30))
enemy_speed = 5
enemies = []
